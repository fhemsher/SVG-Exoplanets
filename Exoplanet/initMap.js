...
feMerge.append("feMergeNode")
   ...
   // .attr("stroke-opacity", ".8")
    ...
    .attr("xlink:href", "graticuleRework.svg")
    ...
    .attr("width", "1")
    .attr("preserveAspectRatio", "none")
    .attr("xlink:href", "Exoplanet/mesoplanet.svg")
    ...
    .attr("width", "1")
    .attr("preserveAspectRatio", "none")
    .attr("xlink:href", "Exoplanet/psychroplanet.svg")
    ...
    .attr("width", "1")
    .attr("preserveAspectRatio", "none")
    .attr("xlink:href", "Exoplanet/non-habitable.svg")
    ...
    .attr("width", "1")
    .attr("preserveAspectRatio", "none")
    .attr("xlink:href", "Exoplanet/hypopsychroplanet.svg")
    ...
    .attr("width", "1")
    .attr("preserveAspectRatio", "none")
    .attr("xlink:href", "Exoplanet/unknown.svg")
    ...
    .attr("width", "1")
    .attr("preserveAspectRatio", "none")
    .attr("xlink:href", "Exoplanet/thermoplanet.svg")
    ...
    .attr("width", "1")
    .attr("preserveAspectRatio", "none")
    .attr("xlink:href", "Exoplanet/hypothermoplanet.svg")
...
function loadHostStars()
{

   // HostG=CelestialG.append("g")
   var starColor = d3.scale.category20();
    ...
    .enter().append("text")
  .attr("class", "host")
  .attr("stroke-width", 20*.02)
  .attr("font-size", 20)
  .attr("font-family", "Arial Unicode MS")
  .attr("x", -.4*20)
  .attr("y", .335*20)
  .attr("transform", function(d){ return CelestialPoint([d.S_RA*15, d.S_DEC])})
  .text(String.fromCharCode(code))
  .attr("fill",function(d, i){return starColor(i)})
  .attr("name", function(d){ return d.S_Name})
  .attr("stroke", "black")
  .style("cursor", "default")
    .attr("onmouseover", "showStarName(evt)")
  .attr("onmouseout", "hideStarName(evt)")
